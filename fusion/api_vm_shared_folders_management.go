...
type ApiCreateSharedFolderRequest struct {
	ctx        context.Context
	ApiService *VMSharedFoldersManagementAPIService
	id         string
...
func (r ApiCreateSharedFolderRequest) Parameters(parameters SharedFolder) ApiCreateSharedFolderRequest {
...
type ApiUpdataSharedFolderRequest struct {
	...
	id         string
	folderId   string
	parameters *SharedFolderParameter
	vmPassword *string
}

// Parameters of the shared folder to update to
func (r ApiUpdataSharedFolderRequest) Parameters(parameters SharedFolderParameter) ApiUpdataSharedFolderRequest {
	r.parameters = &parameters
	return r
}
